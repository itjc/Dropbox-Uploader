...
#$CURL_BIN="path to Windows Curl.exe" # http://curl.haxx.se/download.html
...
#$BIN_DEPS="sed basename date grep stat dd mkdir" #does this make sense in Windows?
$VERSION="0.14"

#umask 077 # make sure you have Windows permission to?
...
# not sure if this is an issue. CMD /C DIR lists files with "." anyway.
